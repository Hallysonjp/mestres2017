...
<body class="fix-header card-no-border">
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b>
                            ...
                            <!-- Light Logo icon -->
                            <img src="<?= base_url('assets/images/mestres.png')?>" width="100" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>
                         <!-- dark Logo text -->
                         <img src="<?= base_url('assets/images/mestres.png')?>" alt="homepage" class="dark-logo" />
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                <h4><?= $_SESSION['nome'] ?></h4>
                                                <p class="text-muted"><?= $_SESSION['escola'] ?></p><a href="profile.html" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile" style="background: url(<?= base_url('assets/images/background/user-info.jpg')?>) no-repeat;">
                    ...
                    <!-- User profile text-->
                    <div class="profile-text"> <a href="#" class="dropdown-toggle link u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><?= $_SESSION['nome']?><span class="caret"></span></a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a href="starter-kit.html" aria-expanded="false"><i class="fa fa-circle"></i><span class="hide-menu">Edital</span></a>
                        </li>    
                        <li>
                            <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-map-marker"></i><span class="hide-menu">Inscrição</span></a>
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
            <footer class="footer">
                © 2017 Desenvolvido por Hallyson Ricardo
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
